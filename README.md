...
* Download [**assets/renamer.jar**](https://github.com/imagingbook/gopro-file-renamer/releases/download/latest/renamer.jar) to your local file system. This is an executable
