package imagingbook.demos.console3_good;
...
// https://stackoverflow.com/a/38664810/15716872
...
public class TextAreaLogProgram extends JFrame {
    ...
    private JButton buttonStop = new JButton("Stop");   // wilbur added
    ...
    public TextAreaLogProgram() {
        ...
        constraints.gridx = 2;              // wilbur: place properly
        ...
        // adds event handler for button Stop (wilbur)
